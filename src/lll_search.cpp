/*  Written in 2019 by Guy Steele and Sebastiano Vigna
...
int main(int argc, char *argv[]) {
	...
	if (argc != 5 && argc != 6) {
		...
		cerr << "power-of-two moduli by testing random candidates using the" << endl;
		cerr << "LLL lattice-reduction algorithm. For each multiplier with" << endl;
